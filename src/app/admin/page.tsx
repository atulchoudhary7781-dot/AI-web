                ...
                <CardContent>
                  <div className="space-y-4">
                    {[
                      ...
                      { plan: 'Normal ($10/mo)', count: stats.subscriptions.normal, color: 'bg-blue-500', percentage: (stats.subscriptions.normal / stats.users.total * 100).toFixed(1) },
                      { plan: 'Pro ($20/mo)', count: stats.subscriptions.pro, color: 'bg-purple-500', percentage: (stats.subscriptions.pro / stats.users.total * 100).toFixed(1) },
                    ].map((item) => (
