...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-300 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:ring-2 focus-visible:ring-neon-cyan/50 focus-visible:ring-offset-2 focus-visible:ring-offset-background relative overflow-hidden",
  {
    variants: {
      variant: {
        default:
          "bg-gradient-to-r from-neon-cyan to-neon-cyan text-deep-black font-semibold shadow-glow-cyan hover:shadow-glow-cyan-intense hover:-translate-y-0.5 active:translate-y-0",
        destructive:
        ...
        link:
          "text-neon-cyan underline-offset-4 hover:underline hover:text-neon-cyan transition-colors",
        // NEXUS AI Custom Variants
        neon: 
          "bg-gradient-to-r from-neon-cyan via-neon-cyan to-neon-purple text-deep-black font-bold shadow-glow-cyan hover:shadow-glow-purple-intense hover:-translate-y-1 animate-gradient-shift bg-[length:200%_auto]",
        neonOutline:
